...
def generate_launch_description():
    ...
    # Ponieważ pracujemy tylko z om_x, uprościłem tę część
    urdf_file = "hexapod_static"
    # urdf_folder = "om_x"
    ...
    rviz_config_file = os.path.join(open_manipulator_description_path, 'rviz', 'hexapod.rviz')
